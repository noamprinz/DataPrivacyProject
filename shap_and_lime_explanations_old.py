...
def lime_explanation(model, test_set, output_dir, class_dict, num_samples=5):
    ...
    for i in range(num_samples):
        ...
        plt.bar(range(4), F.softmax(model(image_tensor.unsqueeze(0)), dim=1)[0].detach().numpy())
...
def main():
    ...
    model_path = "SimulationOutputs/try_num_epochs_1/0_model.pth"
    ...
    shap_explanation(model, test_dataset, output_dir, class_dict)
